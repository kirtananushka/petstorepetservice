...
public class PetApiController implements PetApi {
  ...
  @Override
  public ResponseEntity<List<PetDto>> findPetsByStatus(
    ...
    if (acceptType != null && contentType != null && acceptType.contains("application/json")
      ...
      PetApiController.log.info(String.format(
        ...
        status));
      try {
        String petsJSON = new ObjectMapper().writeValueAsString(petService.findAll());
    ...
    return new ResponseEntity<List<PetDto>>(HttpStatus.NOT_IMPLEMENTED);
  }

  @RequestMapping(value = "/allpets", produces = { "application/json" }, method = RequestMethod.GET)
  ...
  @Override
  public ResponseEntity<List<PetDto>> findPetsByTags(
    ...
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<List<PetDto>>(objectMapper.readValue(
        ...
        return new ResponseEntity<List<PetDto>>(HttpStatus.INTERNAL_SERVER_ERROR);
      }
    }
  ...
  public ResponseEntity<PetDto> getPetById(
    ...
    if (accept != null && accept.contains("application/json")) {
      try {
        return new ResponseEntity<PetDto>(objectMapper.readValue(
          ...
          PetDto.class), HttpStatus.NOT_IMPLEMENTED);
      } catch (IOException e) {
        log.error("PetStorePetService Couldn't serialize response for content type application/json", e);
        return new ResponseEntity<PetDto>(HttpStatus.INTERNAL_SERVER_ERROR);
      }
    }
    ...
    return new ResponseEntity<PetDto>(HttpStatus.NOT_IMPLEMENTED);
  }
