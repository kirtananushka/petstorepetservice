drop table if exists petstorepetservice_db.public.pet_tag;
drop table if exists petstorepetservice_db.public.tag;
drop table if exists petstorepetservice_db.public.pet;
drop table if exists petstorepetservice_db.public.category;
